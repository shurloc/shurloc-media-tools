 ...
 */
final class ShurlocMediaSEOServiceTest extends TestCase {
	 ...
	 */
	private Shurloc_Media_SEO_Service $service;
	...
	public function test_get_alt_text_returns_stored_value(): void {
		...
		$GLOBALS['shurloc_test_post_meta'][100]
			[ Shurloc_Media_SEO_Service::ALT_TEXT_META_KEY ] = 'Shur-loc mesh product';
	...
	public function test_get_alt_text_returns_empty_string_for_non_string_value(): void {
		...
		$GLOBALS['shurloc_test_post_meta'][100]
			[ Shurloc_Media_SEO_Service::ALT_TEXT_META_KEY ] = array(
				'invalid',
			);
