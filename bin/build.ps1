...
param(
    [string]$PluginName = "shurloc-media-tools"
)
...
#
if (-not (Test-Path "$PluginRoot\shurloc-media-tools.php")) {
    throw "Plugin bootstrap file 'shurloc-media-tools.php' was not copied."
}
