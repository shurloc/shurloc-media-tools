 ...
 */
final class Shurloc_Media_Library_SEO_Controller {
	 ...
	 * Media SEO service.
	 *
	 * @var Shurloc_Media_SEO_Service
	 */
	private Shurloc_Media_SEO_Service $seo_service;

	/**
	 * Constructor.
	 *
	 * @param Shurloc_Media_SEO_Service $seo_service Media SEO service.
	 */
	public function __construct(
		Shurloc_Media_SEO_Service $seo_service
	) {
	...
	public function render_column(
		...
		if (
			...
			<span
				...
				aria-label="<?php echo esc_attr__( 'Alt text present', 'shurloc-media-tools' ); ?>"
				title="<?php echo esc_attr__( 'Alt text present', 'shurloc-media-tools' ); ?>"
			>
				✓
			</span>
			<?php
		...
		<span
			...
			aria-label="<?php echo esc_attr__( 'Alt text missing', 'shurloc-media-tools' ); ?>"
			title="<?php echo esc_attr__( 'Alt text missing', 'shurloc-media-tools' ); ?>"
		>
			✗
		</span>
		<?php
	...
	public function configure_media_query(
		...
		if (
			...
			$query->set(
				'meta_key',
				Shurloc_Media_SEO_Service::ALT_TEXT_META_KEY
			);
	...
	public function enqueue_assets(
		...
		wp_enqueue_style(
			...
			SHURLOC_MEDIA_TOOLS_URL .
				'assets/css/shurloc-media-library-seo.css',
			array(),
